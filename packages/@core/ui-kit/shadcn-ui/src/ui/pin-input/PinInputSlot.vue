...
<template>
  <PinInputInput
    ...
    :class="
      cn(
        'border-input focus:border-primary focus:ring-primary/15 focus:aria-invalid:ring-destructive/20 dark:bg-input/30 dark:focus:aria-invalid:ring-destructive/40 aria-invalid:border-destructive focus:aria-invalid:border-destructive relative flex h-9 w-9 items-center justify-center border text-center text-sm shadow-xs transition-all outline-none focus:z-10 focus:ring-3',
        props.class,
      )
    "
  />
