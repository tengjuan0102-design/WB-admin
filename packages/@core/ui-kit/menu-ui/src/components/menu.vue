...
.#{$namespace}-menu {
  ...
  &.is-vertical {
    ...
    --menu-item-active-background-color: #fff !important;
    --menu-item-hover-background-color: rgb(255 255 255 / 55%) !important;
    --menu-submenu-background-color: transparent !important;
    --menu-submenu-hover-background-color: rgb(255 255 255 / 55%) !important;
    --menu-submenu-active-background-color: transparent !important;
    ...
    &:not(.#{$namespace}-menu.is-collapse) {
      ...
      & > .#{$namespace}-sub-menu {
        & > .#{$namespace}-menu {
          & > .#{$namespace}-menu-item {
            padding-left: calc(var(--menu-item-indent) + 20px);
          }
        }
